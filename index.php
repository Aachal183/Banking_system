...
.pic1{margin-left:120px;
		  margin-top:50px;
		  height:260px;
		  width:300px;
    }
.pic2{margin-left:170px;
		  margin-top:50px;
		  height:260px;
		  width:300px;
    }
.user{margin-left:230px; 
      font-size:45px;
      margin-top: 10px;
    }
.money{margin-left:160px; 
      font-size:45px;
      margin-top: 10px;
    }
.pic3{margin-left:200px;
		  margin-top:50px;
		  height:260px;
		  width:300px;
    }
.record{margin-left:170px; 
      font-size:45px;
      margin-top: 10px;
    }
</style>
