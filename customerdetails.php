...
<div class="row">
    ...
    <span class="font-weight-bold" style="color:#800000;font-size:3em;line-height:1em;">Customer Details</span>
       ...
       <?php
        if (isset($_POST['user']))
        {
          ...
          $result=mysqli_query($conn,"SELECT * FROM customers WHERE Name='$name'");  
    ...
    <div class="col-sm" style="padding:1% 3%;">
        <div >
                    ...
                    <span class="font-weight-bold" style="color:#800000;font-size:3em;line-height:2em;">Money Transfer</span>
                    <br><br>
          ...
          ?>
                ...
                $res = mysqli_query($db, "SELECT * FROM customers WHERE Name!='$name'");  
                ...
                <br><br><br>
                        ...
                        <br><br><br>
                       <input type="submit" class='btn btn-secondary' name="transfer" value="transfer">  
                        </form>
        </div>
    </div>
</div>
